  ...
  const relations = [
    ...(node.relatedAnime || []).map((r: MalAnimeRelation) => ({
      ...
      media: {
        ...
        trending: null,
        genres_rank: [],
        cover_image: { extra_large: null, large: r.anime.mainPicture?.large || null, medium: r.anime.mainPicture?.medium || null, color: null },
        banner_image: null,
        trailer: null,
    ...
    ...((node.relatedManga || []) as MalMangaRelation[]).map((r: MalMangaRelation) => ({
      ...
      media: {
        ...
        trending: null,
        genres_rank: [],
        cover_image: { extra_large: null, large: r.manga.mainPicture?.large || null, medium: r.manga.mainPicture?.medium || null, color: null },
        banner_image: null,
        trailer: null,
